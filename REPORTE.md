...
- **Rangos:** Cadete → Alférez (220) → Teniente (520) → Primer Oficial (700) → Capitán IA (900). Recalibrados el 16/09/2026 porque el juego quedó más corto: una pasada limpia da 880 XP, la misma proporción de antes contra el premio.
- **Todo el contenido pendiente está anclado a Milla Azul** (17/09/2026), el negocio real de Daniel: insumos de pesca para principiantes, con asesoría. Las etapas 8 y 9 se rehicieron ejercicio por ejercicio sin cambiarles el tema.
